...
#define ZERO_TIMEOUT_MS 20000 // Timeout for zeroing the motor in milliseconds
...
struct StepperMotor {
    ...
    int slow_stepSpeed = 50; // Default slow step speed in microseconds
    int fast_stepSpeed = 25; // Default step speed in microseconds
...
StepperMotor motors[] = {
    {WL_DIR, WL_STEP, WL_LIMIT_SWITCH, "WL", 50, 25, HIGH, HIGH},
    {SLIT1_DIR, SLIT1_STEP, SLIT1_LIMIT_SWITCH, "SLIT1", 200, 150, LOW, LOW},
    {SLIT2_DIR, SLIT2_STEP, SLIT2_LIMIT_SWITCH, "SLIT2", 200, 150, LOW, LOW},
    {SLIT3_DIR, SLIT3_STEP, SLIT3_LIMIT_SWITCH, "SLIT3", 200, 150, LOW, LOW} 
};
